...
var RR1_TIMEOUT time.Duration = 30 * time.Second                    // Tempo dopo il quale si considera perso un messaggio client-server e quindi si ritrasmette la richiesta di esec del servizio
