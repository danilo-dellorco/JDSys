...
var FILETRANSFER_TERMINATING_PORT string = ":7777"    // Porta su cui il nodo ascolta l'update mongo da altri nodi
var FILETRANSFER_RECONCILIATION_PORT string = ":6666" // Porta su cui il nodo ascolta l'update mongo da altri nodi
